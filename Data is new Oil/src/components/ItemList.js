						...
						{item.card.info.imageId ? (
							<div>
								<img
									...
									alt=""
								/>
								<button className="font-bold bg-green-700 text-white px-3 py-2 absolute bottom-3 rounded-tr-xl  rounded-bl-xl">
									Add+
								</button>
							</div>
						) : (
							<div>
								<button className="font-bold bg-green-700 text-white px-3 py-2 absolute bottom-3 rounded-xl">
									Add+
								</button>
							</div>
						)}
